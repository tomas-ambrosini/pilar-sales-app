export const DEFAULT_TEMPLATE_CONFIG = {
    ...
    invoiceMessage: "Thank you for your business. Please contact us if you have any questions regarding this invoice or your service.",
    invoiceFooter: "Invoice generated by Pilar Sales Platform",
    invoicePaymentTerms: "Due upon receipt"
};
...
export function normalizeContractTemplate(dbTemplate) {
    ...
    return {
        ...
        invoiceMessage: dbTemplate.invoice_customer_message || DEFAULT_TEMPLATE_CONFIG.invoiceMessage,
        invoiceFooter: dbTemplate.invoice_footer_text || DEFAULT_TEMPLATE_CONFIG.invoiceFooter,
        invoicePaymentTerms: dbTemplate.invoice_payment_terms || DEFAULT_TEMPLATE_CONFIG.invoicePaymentTerms
    };
}

...
export const BADGE_REGISTRY = {
  piedra_angular: {
    ...
    svg: iconPillar,
    gradient: 'linear-gradient(135deg, #001050, #001b71, #002a8f)',
    glow: 'rgba(0, 27, 113, 0.4)',
    ring: 'rgba(0, 42, 143, 0.6)',
    tooltipBg: '#001050',
    bg: 'bg-[#001b71]',
    text: 'text-white',
    border: 'border-[#001050]',
    auto: true,
  },
  raices: {
    key: 'raices',
    ...
    svg: iconRoot,
    gradient: 'linear-gradient(135deg, #2d9a3d, #39b54a, #4fce5f)',
    glow: 'rgba(57, 181, 74, 0.35)',
    ring: 'rgba(79, 206, 95, 0.5)',
    tooltipBg: '#1a6b28',
    bg: 'bg-[#39b54a]',
    text: 'text-white',
    border: 'border-[#2d9a3d]',
    auto: true,
  },
  brote: {
    key: 'brote',

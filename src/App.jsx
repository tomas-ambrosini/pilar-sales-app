    ...
    <Routes>
      ...
      {!user ? (
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="dispatch" element={<RoleRoute allowedRoles={['SUPER_ADMIN', 'DIRECTOR', 'MANAGER', 'COORDINATOR']} allowedDepartments={['DISPATCH', 'SERVICE', 'INSTALL', 'SALES']}><DispatchHub /></RoleRoute>} />

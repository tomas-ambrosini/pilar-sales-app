...
export default function ProposalViewerModal({ isOpen, onClose, onBack, proposal, onAccept, onViewContract, onDeclineFull }) {
  ...
  return typeof document !== 'undefined' ? createPortal(
    <div className={`fixed inset-0 z-[5000] flex items-center justify-center modal-layout-wrapper transition-opacity duration-300 ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
       {/* Backdrop */}

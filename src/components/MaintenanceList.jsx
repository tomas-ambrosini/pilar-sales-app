        ...
        <div className="space-y-4">
            {agreements.map((job, idx) => (
                <motion.div 
                    ...
                    key={job.id} 
                    className="group bg-white border border-slate-200/60 rounded-2xl p-5 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 hover:border-blue-200 transition-all duration-300 flex flex-col xl:flex-row gap-6 items-start xl:items-center cursor-pointer overflow-hidden relative"
                >
                    ...
                    <div className="flex-1 relative z-10">
                        <div className="flex items-center gap-3 mb-1.5 flex-wrap">
                            ...
                            {job.isDueForService && (
                                <span className="bg-gradient-to-r from-amber-100 to-orange-100 text-amber-800 border border-amber-200/50 text-[10px] font-black tracking-widest uppercase px-2.5 py-1 rounded-md flex items-center gap-1 shadow-sm">
                                    <Clock size={12} /> Service Due
                                </span>
                            )}
                            {job.isExpiringSoon && (
                                <span className="bg-gradient-to-r from-purple-100 to-fuchsia-100 text-purple-800 border border-purple-200/50 text-[10px] font-black tracking-widest uppercase px-2.5 py-1 rounded-md flex items-center gap-1 shadow-sm">
                    ...
                    <div className="flex items-center gap-6 px-0 xl:px-8 border-l-0 xl:border-l border-r-0 xl:border-r border-slate-100 shrink-0 w-full xl:w-auto relative z-10">
                    ...
                    <div className="hidden xl:flex absolute right-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:-translate-x-0 transition-all duration-300 pointer-events-none">
